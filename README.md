...
- [Blueprint compiler](https://gnome.pages.gitlab.gnome.org/blueprint-compiler/) (>= 0.20)
...
- run: build and run the application (defaults to the development mock backend)
- mock: run the application explicitly with mock data
- build-mock: build and run the application with mock data
...
To start the client with the in-memory mock backend:

    make mock
    # or build and start it in one command
    make build-mock
